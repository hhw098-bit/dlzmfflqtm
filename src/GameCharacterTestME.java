...
public class GameCharacterTestME {
...
*/
	...
	*/	
	...
	void takeDamage(int dmg) {
		...
		if( hp <= 0){
			...
			hp=0;
			System.out.println(name+"_님의 hp가 "+ hp +"이 되어 사망하셨습니다!! _@ㅠ@_");
			
		}else {
			exp=0;
			System.out.println(name+"_님은 피해를 입었다! 남은 체력: "+ hp);
		}
	...
	*/
	void printStatus() {
		// TODO: 상태 출력_이름: 용사 / 레벨: 2 / 체력: 70 / 경험치: 0
	...
	public static void main(String[] args) {
		...
		//1. 객체 생성
		GameCharacterTestME c = new GameCharacterTestME();
		...
		c.printStatus();	// 이름: 용사 / 레벨: 2 / 체력: 70 / 경험치: 0
		//-----------------------------------------ext
		c.takeDamage(30);
		c.gainExp(50);
		c.takeDamage(30);
